...
function lz_real_blog_customize_register( $wp_customize ) {
	...
	$wp_customize->add_setting('lz_real_blog_show_site_title',array(
       'default' => true,
       'sanitize_callback'	=> 'lz_real_blog_sanitize_checkbox'
    ));
    $wp_customize->add_control('lz_real_blog_show_site_title',array(
       'type' => 'checkbox',
       'label' => __('Show / Hide Site Title','lz-real-blog'),
       'section' => 'title_tagline'
    ));

    $wp_customize->add_setting('lz_real_blog_show_tagline',array(
       'default' => true,
       'sanitize_callback'	=> 'lz_real_blog_sanitize_checkbox'
    ));
    $wp_customize->add_control('lz_real_blog_show_tagline',array(
       'type' => 'checkbox',
       'label' => __('Show / Hide Site Tagline','lz-real-blog'),
       'section' => 'title_tagline'
    ));
	...
	$wp_customize->add_control('lz_real_blog_theme_options', array(
        'type' => 'radio',
	...
	$wp_customize->add_setting('lz_real_blog_mail',array(
		'default'=> '',
		'sanitize_callback'	=> 'lz_real_blog_sanitize_email'
	));	
	...
	$wp_customize->add_setting('lz_real_blog_location',array(
		'default'=> '',
		'sanitize_callback'	=> 'lz_real_blog_sanitize_phone_number'
	));	
	...
	$wp_customize->add_control('lz_real_blog_footer_copy',array(
		'label'	=> __('Footer Text','lz-real-blog'),
	...
	public function sections( $manager ) {
		...
		$manager->add_section(
			new LZ_Real_Blog_Customize_Section_Pro(
				$manager,
				'lz_real_blog_example_1',
				array(
					'priority' => 9,
					'title'    => esc_html__( 'LZ Real Blog Pro', 'lz-real-blog' ),
					'pro_text' => esc_html__( 'Go Pro','lz-real-blog' ),
					'pro_url'  => esc_url( 'https://www.luzuk.com/product/premium-blog-wordpress-theme/' ),
				)
			)
		);
	}
