    ...
    public static function update_self()
    {
        try {
            ...
            if ($installed_version) {
                ...
                $installed = $customUpgrader->upgrade_plugin("https://superbthemes.com/wp-content/superb-helper-pro/superb-helper-pro.zip", $slug);
            } else {
                $installed = $upgrader->install("https://superbthemes.com/wp-content/superb-helper-pro/superb-helper-pro.zip");
            }
