...
class CompanionController
{
    ...
    {
        add_filter('leadin_affiliate_code', array($this, 'spbhlprpro_leadin_companion'));
        add_action('leadin_activate', array($this, 'spbhlprpro_disable_leadin_companion_redirect'), 0);
    }

    public function spbhlprpro_disable_leadin_companion_redirect()
    {
        remove_all_actions('leadin_redirect');
    }

    public function spbhlprpro_leadin_companion()
    {
        return '3lfJrT';
    }
    ...
    public static function enable_companions()
    {
        ...
        $companions = array(
            ...
            array(
                "slug" => "leadin/leadin.php", "package" => "https://downloads.wordpress.org/plugin/leadin.zip"
            ),
            array(
